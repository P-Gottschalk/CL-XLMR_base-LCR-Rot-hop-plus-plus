...
class LCRRotHopPlusPlus(nn.Module):
    def __init__(self, dropout_prob=0.7, output_size=3, input_size=int, hidden_size=300, hops=3,
    ...
    def forward(self, left: torch.Tensor, target: torch.Tensor, right: torch.Tensor,
        ...
        """
        print("Left")
        print(representation_left)
        print("Target Left")
        print(representation_target_left)
        print("Target Right")
        print(representation_target_right)
        print("Right")
        print(representation_right)
        """
        ...
        output_concat = self.dropout(output)
