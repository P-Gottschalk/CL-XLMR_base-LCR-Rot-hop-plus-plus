...
class EmbeddingsDataset(Dataset):
    def __init__(self, year: int, language: str, model: str, phase='Train', ont_hops: Optional[int] = None, device=torch.device('cuda'),
                 empty_ok=False, enable_cache=True, use_vm=True, use_soft_pos=True):
        self.dir = f'/content/drive/MyDrive/Thesis_Data/data/embeddings/{year}-{phase}-{language}-{model}'
...
def train_validation_split(dataset: EmbeddingsDataset, validation_size=0.2, seed = 42):
